...
public class HangManGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblGuess.setText("What letter would you like to try?");
        lblGuess.setRequestFocusEnabled(false);
        lblGuess.setVerifyInputWhenFocusTarget(false);

        txtGuess.setFocusCycleRoot(true);

        btnGuess.setText("Check Guess");
